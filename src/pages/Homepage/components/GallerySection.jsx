    ...
    >
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
        {galleryImages.map((image) => (
          <div
            key={image.id}
            className="relative overflow-hidden rounded-2xl aspect-square bg-slate-100"
          >
            <Image
              src={image.src}
              alt={image.alt}
            ...
            />
            <div className="absolute inset-0 flex items-end p-3 bg-gradient-to-t from-black/55 via-transparent to-transparent">
