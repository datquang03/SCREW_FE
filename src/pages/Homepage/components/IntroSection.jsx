...
import image1 from "../../../assets/z7660004019934_88b62e990d25d8f8c9d6a71b192ed566.jpg";
import image2 from "../../../assets/z7660004033984_6670632da746afc25de52961ca4247b9.jpg";
      ...
      <div className="relative min-h-[420px] flex flex-col justify-center items-center text-center overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-3xl mx-auto px-4 py-10 md:py-14 lg:py-16">
          ...
          <p className="text-base sm:text-lg md:text-2xl text-white/90 mb-2 font-normal">
            Đặt studio chụp ảnh, thu âm, quay phim chuyên nghiệp chỉ trong vài
            giây cùng S Cộng Studio.
          </p>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-2 sm:px-4 md:px-8 lg:px-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 items-center">
            ...
            <div className="space-y-6">
              <p className="text-xs font-semibold text-[#C5A267] uppercase tracking-[0.3em] mb-4">
                KHÁM PHÁ
              </p>
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold text-[#0F172A] mb-2 leading-tight">
                Khám phá cùng{" "}
                <span className="text-[#C5A267]">S Cộng Studio</span>
              </h1>
              <p className="text-base sm:text-lg text-slate-600 mb-6 max-w-xl">
                Đăng không gian studio của bạn lên S Cộng để kết nối với hàng
                ngàn khách hàng sáng tạo tại thành phố của bạn.
              </p>
            ...
            <div className="grid grid-cols-2 grid-rows-3 gap-3 sm:gap-4 h-full">
              <img
                src={image3}
                alt="studio1"
                className="object-cover w-full h-28 sm:h-32 md:h-36 lg:h-40 col-span-2 row-span-1 border border-slate-100 transition-all duration-500"
              />
              <img
                src={image2}
                alt="studio2"
                className="object-cover w-full h-28 sm:h-32 md:h-36 lg:h-40 col-span-1 row-span-2 border border-slate-100 transition-all duration-500"
              />
              <img
                src={image1}
                alt="studio3"
                className="object-cover w-full h-28 sm:h-32 md:h-36 lg:h-40 col-span-1 row-span-1 border border-slate-100 transition-all duration-500"
              />
              <img
                src={image4}
                alt="studio4"
