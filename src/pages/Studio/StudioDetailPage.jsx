    ...
    dispatch(getActiveStudios({ page: 1, limit: 20 })).then((res) => {
      if (res?.payload?.data) {
        ...
        const filtered = res.payload.data.filter(
          (s) =>
            s._id !== safeStudio._id &&
            (s.category === cat || s.categories?.includes(cat))
        );
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA] text-[#1A1A1A]">
          ...
          <div className="grid lg:grid-cols-12 gap-8 items-end">
            <div className="lg:col-span-8 space-y-6">
              ...
              <h1 className="text-5xl md:text-7xl font-bold text-white leading-[1.1]">
                {safeStudio.name?.split(" ").slice(0, -1).join(" ") ||
                  safeStudio.name ||
                  ""}{" "}
                <br />
                <span className="font-semibold text-[#C5A267]">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <Suspense
          fallback={
            <div className="text-center py-20 font-serif italic text-slate-400">
        ...
        >
          <div className="grid lg:grid-cols-12 gap-10">
            ...
            <div className="lg:col-span-8 space-y-16">
              ...
              <div
                id="gallery"
                className="bg-white p-2 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.03)] border border-gray-100 overflow-hidden"
              >
              ...
              >
                ...
                <div className="bg-white border border-gray-100 shadow-sm p-8">
                  <div className="grid md:grid-cols-2 gap-8">
                    <div>
                      <h4 className="text-sm font-bold text-[#C5A267] uppercase tracking-widest mb-4">
                        Địa chỉ
                      </h4>
                      <p className="text-slate-700 leading-relaxed mb-6">
                        {safeStudio.location ||
                          "1 Trương Đình Hợi, Phường 18, Quận 4 , TP.HCM, Ho Chi Minh City, Vietnam"}
                      </p>

                      <h4 className="text-sm font-bold text-[#C5A267] uppercase tracking-widest mb-4 mt-6">
                        Giờ mở cửa
                      </h4>
                          ...
                          <div className="flex items-center gap-3 mb-2">
                            ...
                            <span className="ml-auto">
                              <Button
                                type="text"
                                icon={
                                  <FiAlertCircle className="text-red-500 opacity-0 group-hover:opacity-100 transition-opacity duration-200" />
                                }
                                size="small"
                                style={{
                                  padding: 0,
                    ...
                    >
                      <Select
                        options={[
                          ...
                          {
                            value: "abuse",
                            label: "Lạm dụng/ngôn từ không phù hợp",
                          },
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3">
                      ...
                      <span className="text-sm leading-relaxed">
                        Trang thiết bị chuyên nghiệp, hiện đại nhất
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="text-[#0F172A] text-lg mt-0.5">✓</span>
                      <span className="text-sm leading-relaxed">
                        Đội ngũ hỗ trợ kỹ thuật tận tâm 24/7
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="text-[#0F172A] text-lg mt-0.5">✓</span>
                    ...
                    <li className="flex items-start gap-3">
                      <span className="text-[#0F172A] text-lg mt-0.5">✓</span>
                      <span className="text-sm leading-relaxed">
                        Hỗ trợ hủy & hoàn tiền linh hoạt
                      </span>
                    </li>
                  </ul>
                </div>
                    ...
                    <div className="space-y-6">
                      {relatedStudios.map((studio) => (
                        ...
                        >
                          ...
                          <div>
                            <div className="font-semibold text-sm text-slate-800 group-hover:text-[#C5A267] transition-colors line-clamp-1">
                              {studio.name}
                            </div>
                            <div className="text-[10px] font-bold text-[#C5A267] uppercase tracking-widest mt-1">
                              {studio.basePricePerHour?.toLocaleString()}đ{" "}
