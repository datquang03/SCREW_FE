      ...
      {!user ? (
        <div className="mb-8 flex flex-col items-center justify-center bg-white border border-red-200 rounded-lg p-6 text-center">
          ...
          <p className="text-sm text-gray-500 mb-4">
            Vui lòng đăng nhập để bình luận và tham gia thảo luận.
          </p>
          <a
            href="/login"
            className="inline-block px-6 py-2 bg-[#C5A267] hover:bg-[#A0826D] text-white font-bold rounded transition-all shadow-md"
          >
            Đăng nhập ngay
          </a>
        </div>
        ...
        <div className="mb-8">
          <div className="flex gap-4 items-start">
            ...
            <button
              ...
              disabled={loading}
              className="bg-[#b3a386] hover:bg-[#918a85] text-white px-6 py-3 font-bold transition-all disabled:opacity-50 shadow-md hover:shadow-lg cursor-pointer"
            >
              Gửi
            </button>
          </div>
          ...
          localComments.map((c, idx) => (
            ...
            >
              <div className="flex items-center gap-3 mb-3">
                ...
                <button
                  className="ml-auto flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity text-red-500 px-3 py-1 hover:bg-red-50 border border-red-200 cursor-pointer rounded"
              ...
              <div className="text-[#0F172A] text-base leading-relaxed mb-3">
                {c.content}
              </div>
              {c.rating && (
              ...
              {openReply === c._id && (
                <div className="mt-4 space-y-3 pl-4 border-l-2 border-[#C5A267]">
                  <textarea
                    ...
                    className="w-full p-3 border-2 border-slate-200 outline-none focus:border-[#C5A267] focus:ring-2 focus:ring-[#C5A267]/20 text-sm cursor-pointer"
                    disabled={loading}
                  />
                  <div className="flex gap-2">
                    <button
                      ...
                      disabled={loading}
                      className="px-4 py-2 bg-[#c9b9af] hover:bg-[#a59c92] text-white font-semibold disabled:opacity-50 transition-colors cursor-pointer"
                    >
                      Gửi
                    </button>
                    <button
                    ...
                    >
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity text-red-500 p-1 hover:underline cursor-pointer"
